...
/***/ function(module, exports, __webpack_require__) {
	...
	var _paddockForm = __webpack_require__(199);

	var _paddockForm2 = _interopRequireDefault(_paddockForm);
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'div',
	            null,
	            _react2['default'].createElement(_paddockForm2['default'], {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PaddockForm = (function (_React$Component) {
	  _inherits(PaddockForm, _React$Component);

	  function PaddockForm() {
	    _classCallCheck(this, PaddockForm);

	    _get(Object.getPrototypeOf(PaddockForm.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(PaddockForm, [{
	    key: 'handleSubmit',
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            this.props.points.map(function (point, index) {
	              return _react2['default'].createElement(
	                'span',
	                null,
	                _react2['default'].createElement('input', { type: 'text', key: "x" + index, className: 'form-control', ref: 'one' }),
	                _react2['default'].createElement('input', { type: 'text', key: "y" + index, className: 'form-control', ref: 'two' })
	              );
	            })
	          )
	        ),
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'button',
	            { className: 'btn btn-primary', onClick: this.add.bind(this) },
	            'Add'
	          ),
	          _react2['default'].createElement(
	            'button',
	            { className: 'btn btn-primary', style: { marginLeft: 10 }, onClick: this.handleSubmit.bind(this) },
	            'Submit'
	          )
	        )
	      );
